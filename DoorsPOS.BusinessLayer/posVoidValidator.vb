...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As posVoid
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your posVoid class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(posVoidValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(posVoidValidator.ColumnNames.DateColumnNameHere)
