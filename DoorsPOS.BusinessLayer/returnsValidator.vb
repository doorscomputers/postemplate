...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As returns
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your returns class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(returnsValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(returnsValidator.ColumnNames.DateColumnNameHere)
