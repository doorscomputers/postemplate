...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As dept
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your dept class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(deptValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(deptValidator.ColumnNames.DateColumnNameHere)
