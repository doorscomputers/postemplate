...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As pos_dettmp
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your pos_dettmp class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(pos_dettmpValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(pos_dettmpValidator.ColumnNames.DateColumnNameHere)
