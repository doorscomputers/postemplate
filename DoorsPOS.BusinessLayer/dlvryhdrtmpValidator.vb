...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As dlvryhdrtmp
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your dlvryhdrtmp class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(dlvryhdrtmpValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(dlvryhdrtmpValidator.ColumnNames.DateColumnNameHere)
