...
''' <summary>
''' This class contains properties for each data value that makes up a dept.
...
#Region "Constructor"
  ''' <summary>
  ''' Constructor for the dept class
  ''' </summary>
  Public Sub New()
    MyBase.New()
...
#End Region
  ...
  Private _DEPTD As String = String.Empty
...
#Region "Public Properties"
  ...
  Public Property deptid() As Integer
    ...
    Set(ByVal Value As Integer)
      If HasValueChanged(_deptid, Value, "deptid") Then
        _deptid = Value
  ...
  Public Property DEPTD() As String
    ...
    End Get
    Set(ByVal Value As String)
      If HasValueChanged(_DEPTD, Value, "DEPTD") Then
        _DEPTD = Value
        RaisePropertyChanged("DEPTD")
      End If
    End Set
  End Property
  ''' <summary>
