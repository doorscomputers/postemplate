...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As members
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your members class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(membersValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(membersValidator.ColumnNames.DateColumnNameHere)
