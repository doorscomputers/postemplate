...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As pos_det
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your pos_det class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(pos_detValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(pos_detValidator.ColumnNames.DateColumnNameHere)
