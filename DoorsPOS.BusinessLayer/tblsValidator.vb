...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As tbls
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your tbls class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(tblsValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(tblsValidator.ColumnNames.DateColumnNameHere)
