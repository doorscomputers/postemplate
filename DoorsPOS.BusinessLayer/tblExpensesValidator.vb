...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As tblExpenses
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your tblExpenses class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(tblExpensesValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(tblExpensesValidator.ColumnNames.DateColumnNameHere)
