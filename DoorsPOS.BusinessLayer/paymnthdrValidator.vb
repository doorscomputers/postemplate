...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As paymnthdr
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your paymnthdr class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(paymnthdrValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(paymnthdrValidator.ColumnNames.DateColumnNameHere)
