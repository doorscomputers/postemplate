...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As paymntdetl
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your paymntdetl class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(paymntdetlValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(paymntdetlValidator.ColumnNames.DateColumnNameHere)
