...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As bo
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your bo class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(boValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(boValidator.ColumnNames.DateColumnNameHere)
