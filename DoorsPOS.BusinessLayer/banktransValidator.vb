...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As banktrans
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your banktrans class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(banktransValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(banktransValidator.ColumnNames.DateColumnNameHere)
