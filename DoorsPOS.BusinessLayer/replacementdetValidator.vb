...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As replacementdet
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your replacementdet class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(replacementdetValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(replacementdetValidator.ColumnNames.DateColumnNameHere)
