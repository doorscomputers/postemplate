...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As pos_hdrtmp
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your pos_hdrtmp class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(pos_hdrtmpValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(pos_hdrtmpValidator.ColumnNames.DateColumnNameHere)
