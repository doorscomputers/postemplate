...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As PaymentType
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your PaymentType class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(PaymentTypeValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(PaymentTypeValidator.ColumnNames.DateColumnNameHere)
