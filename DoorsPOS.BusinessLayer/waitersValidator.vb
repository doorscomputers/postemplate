...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As waiters
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your waiters class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(waitersValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(waitersValidator.ColumnNames.DateColumnNameHere)
