...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As pohdrtmp
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your pohdrtmp class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(pohdrtmpValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(pohdrtmpValidator.ColumnNames.DateColumnNameHere)
