...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As categories
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your categories class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(categoriesValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(categoriesValidator.ColumnNames.DateColumnNameHere)
