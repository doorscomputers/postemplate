...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As chkpay
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your chkpay class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(chkpayValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(chkpayValidator.ColumnNames.DateColumnNameHere)
