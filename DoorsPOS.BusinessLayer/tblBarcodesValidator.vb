...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As tblBarcodes
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your tblBarcodes class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(tblBarcodesValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(tblBarcodesValidator.ColumnNames.DateColumnNameHere)
