...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As tblreading
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your tblreading class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(tblreadingValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(tblreadingValidator.ColumnNames.DateColumnNameHere)
