...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As stocks
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your stocks class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(stocksValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(stocksValidator.ColumnNames.DateColumnNameHere)
