...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As location
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your location class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(locationValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(locationValidator.ColumnNames.DateColumnNameHere)
