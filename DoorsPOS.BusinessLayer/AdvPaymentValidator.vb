...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As AdvPayment
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your AdvPayment class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(AdvPaymentValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(AdvPaymentValidator.ColumnNames.DateColumnNameHere)
