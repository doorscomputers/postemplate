...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As dlvry_det
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your dlvry_det class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(dlvry_detValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(dlvry_detValidator.ColumnNames.DateColumnNameHere)
