...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As dlvrydettmp
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your dlvrydettmp class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(dlvrydettmpValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(dlvrydettmpValidator.ColumnNames.DateColumnNameHere)
