...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As pos_hdr
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your pos_hdr class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(pos_hdrValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(pos_hdrValidator.ColumnNames.DateColumnNameHere)
