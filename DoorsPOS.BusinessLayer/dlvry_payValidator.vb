...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As dlvry_pay
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your dlvry_pay class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(dlvry_payValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(dlvry_payValidator.ColumnNames.DateColumnNameHere)
