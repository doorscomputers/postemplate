...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As tblChangedPrice
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your tblChangedPrice class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(tblChangedPriceValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(tblChangedPriceValidator.ColumnNames.DateColumnNameHere)
