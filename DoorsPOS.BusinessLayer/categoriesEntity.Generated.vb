...
''' <summary>
''' This class contains properties for each data value that makes up a categories.
...
#End Region
  ...
  Private _catgory As String = String.Empty
...
#Region "Public Properties"
  ...
  Public Property catgory() As String
    ...
    Set(ByVal Value As String)
      If HasValueChanged(_catgory, Value, "catgory") Then
        _catgory = Value
        RaisePropertyChanged("catgory")
      End If
    End Set
  End Property
  ''' <summary>
