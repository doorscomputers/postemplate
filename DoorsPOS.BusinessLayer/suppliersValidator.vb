...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As suppliers
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your suppliers class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(suppliersValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(suppliersValidator.ColumnNames.DateColumnNameHere)
