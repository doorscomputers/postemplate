...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As additnlcash
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your additnlcash class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(additnlcashValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(additnlcashValidator.ColumnNames.DateColumnNameHere)
