...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As receive_hdr
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your receive_hdr class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(receive_hdrValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(receive_hdrValidator.ColumnNames.DateColumnNameHere)
