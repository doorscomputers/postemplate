...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As tblExpenseTrans
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your tblExpenseTrans class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(tblExpenseTransValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(tblExpenseTransValidator.ColumnNames.DateColumnNameHere)
