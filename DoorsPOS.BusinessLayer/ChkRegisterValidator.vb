...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As ChkRegister
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your ChkRegister class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(ChkRegisterValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(ChkRegisterValidator.ColumnNames.DateColumnNameHere)
