...
''' <summary>
''' This class contains properties for each data value that makes up a additnlcash.
...
#Region "Constructor"
  ''' <summary>
  ''' Constructor for the additnlcash class
  ''' </summary>
  Public Sub New()
    MyBase.New()
    
    ClassName = "additnlcash"
  End Sub
#End Region
  ...
  Private _acamnt As Decimal = 0
  Private _acremarks As String = String.Empty
...
#Region "Public Properties"
  ...
  Public Property acid() As Integer
    ...
    Set(ByVal Value As Integer)
      If HasValueChanged(_acid, Value, "acid") Then
        _acid = Value
        RaisePropertyChanged("acid")
      End If
    End Set
  End Property
  ''' <summary>
  ...
  End Property
  ''' <summary>
  ''' Get/Set the acamnt value
  ''' </summary>
  <DataMember()> _
  Public Property acamnt() As Decimal
    Get
      Return _acamnt
    End Get
    Set(ByVal Value As Decimal)
      If HasValueChanged(_acamnt, Value, "acamnt") Then
        _acamnt = Value
        RaisePropertyChanged("acamnt")
      End If
    End Set
  End Property
  ''' <summary>
  ''' Get/Set the acremarks value
  ''' </summary>
  <DataMember()> _
  Public Property acremarks() As String
    Get
      Return _acremarks
    End Get
    Set(ByVal Value As String)
      If HasValueChanged(_acremarks, Value, "acremarks") Then
        _acremarks = Value
        RaisePropertyChanged("acremarks")
      End If
    End Set
  End Property
  ''' <summary>
