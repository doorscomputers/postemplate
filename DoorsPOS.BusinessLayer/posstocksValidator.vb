...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As posstocks
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your posstocks class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(posstocksValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(posstocksValidator.ColumnNames.DateColumnNameHere)
