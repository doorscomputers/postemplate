...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As ReadingSum
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your ReadingSum class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(ReadingSumValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(ReadingSumValidator.ColumnNames.DateColumnNameHere)
