...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As payment
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your payment class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(paymentValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(paymentValidator.ColumnNames.DateColumnNameHere)
