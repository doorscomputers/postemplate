...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As dlvry_hdr
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your dlvry_hdr class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(dlvry_hdrValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(dlvry_hdrValidator.ColumnNames.DateColumnNameHere)
