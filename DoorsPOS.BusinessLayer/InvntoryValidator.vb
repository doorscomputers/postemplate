...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As Invntory
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your Invntory class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(InvntoryValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(InvntoryValidator.ColumnNames.DateColumnNameHere)
