...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As EmployeeTrans
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your EmployeeTrans class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(EmployeeTransValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(EmployeeTransValidator.ColumnNames.DateColumnNameHere)
