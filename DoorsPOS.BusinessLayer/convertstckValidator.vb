...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As convertstck
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your convertstck class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(convertstckValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(convertstckValidator.ColumnNames.DateColumnNameHere)
