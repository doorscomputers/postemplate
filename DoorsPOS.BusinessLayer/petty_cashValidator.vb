...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As petty_cash
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your petty_cash class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(petty_cashValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(petty_cashValidator.ColumnNames.DateColumnNameHere)
