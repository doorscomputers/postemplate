...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As receive_det
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your receive_det class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(receive_detValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(receive_detValidator.ColumnNames.DateColumnNameHere)
