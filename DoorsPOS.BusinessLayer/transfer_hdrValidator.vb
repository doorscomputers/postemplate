...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As transfer_hdr
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your transfer_hdr class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(transfer_hdrValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(transfer_hdrValidator.ColumnNames.DateColumnNameHere)
