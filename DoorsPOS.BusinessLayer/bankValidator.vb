...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As bank
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your bank class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(bankValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(bankValidator.ColumnNames.DateColumnNameHere)
