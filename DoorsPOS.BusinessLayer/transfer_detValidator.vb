...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As transfer_det
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your transfer_det class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(transfer_detValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(transfer_detValidator.ColumnNames.DateColumnNameHere)
