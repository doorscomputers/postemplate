...
#Region "CreateNewEntity Method"
	...
	''' </summary>
	Public Function CreateNewEntity() As ChkIssued
...
#Region "ValidateCore Method"
  ''' <summary>
  ''' Used to validate any custom business rules on your ChkIssued class.
...
#Region "AddBusinessRulesToProperties"
  ...
  Protected Overrides Sub AddBusinessRulesToProperties()
    ...
    'prop = Properties.GetByName(ChkIssuedValidator.ColumnNames.ColumnNameHere)
    'prop.MinLength = 6

    'prop = Properties.GetByName(ChkIssuedValidator.ColumnNames.DateColumnNameHere)
