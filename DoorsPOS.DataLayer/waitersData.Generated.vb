...
#Region "Constructors"
  ...
  Public Sub New()
    ...
    _Entity = New waiters()
    ValidatorObject = New waitersValidator(_Entity)
  ...
  ''' <param name="entity">An instance of a waiters</param>
  Public Sub New(ByVal dataProvider As PDSADataProvider, ByVal entity As waiters)
  ...
  Public Sub New(ByVal dataProvider As PDSADataProvider, _
    ByVal entity As waiters, ByVal validator As waitersValidator)
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ClassName = "waitersData"
    DBObjectName = "waiters"
    SchemaName = "dbo"
...
#Region "InitDataColumns Method"
  ...
  Protected Overrides Sub InitDataColumns()
    ...
    prop = ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.wtid)
    ...
    prop = ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.waiter)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.pword)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlChars.Null
...
#Region "EntityDataToColumnCollection Method"
  ...
  Protected Overrides Sub EntityDataToColumnCollection()
    ...
    ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.wtid).Value = Entity.wtid
    ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.waiter).Value = Entity.waiter
    ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.pword).Value = Entity.pword
  End Sub
#End Region
...
#Region "ColumnCollectionToEntityData Method"
  ...
  Protected Overrides Sub ColumnCollectionToEntityData()
    If ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.wtid).IsNull = False Then
      Entity.wtid = ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.wtid).GetAsInteger()
    Else
      Entity.wtid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.waiter).IsNull = False Then
      Entity.waiter = ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.waiter).GetAsString()
    Else
      Entity.waiter = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.pword).IsNull = False Then
      Entity.pword = ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.pword).GetAsString()
    Else
...
#Region "CreateEntityFromDataRow Method"
  ...
  Public Function CreateEntityFromDataRow(ByVal dr As DataRow) As waiters
    ...
    Select Case SelectFilter
      Case SelectFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT wtid, waiter, pword FROM dbo.waiters")
      ...
      Case SelectFilters.ListBox
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT wtid, waiter FROM dbo.waiters")
      ...
      Case SelectFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT wtid, waiter FROM dbo.waiters WHERE wtid = @wtid And waiter = @waiter")
    ...
    Select Case InsertFilter
      Case InsertFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" INSERT INTO dbo.waiters ( wtid, waiter, pword ) VALUES ( @wtid, @waiter, @pword )")
    ...
    Select Case UpdateFilter
      Case UpdateFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" UPDATE dbo.waiters SET wtid = @wtid, waiter = @waiter, pword = @pword WHERE wtid = @wtid And waiter = @waiter")
...
#Region "DeleteByPK Method"
  ...
  ''' <returns>int</returns>
  Public Function DeleteByPK(ByVal wtid As Integer) As Integer
    ...
    Select Case DeleteFilter
      Case DeleteFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.waiters")
      ...
      Case DeleteFilters.DeleteByPK
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.waiters WHERE wtid = @wtid And waiter = @waiter")
    ...
    Select Case RowCountFilter
      Case RowCountFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT Count(*) As NumRecs FROM dbo.waiters")
...
#Region "LoadByPK Method"
  ...
  Public Function LoadByPK(ByVal wtid As Integer) As Integer
...
#Region "WhereClauseSQL Method"
  ...
  Public Overrides Function WhereClauseSQL() As String
    ...
    Select Case WhereFilter
      ...
      Case WhereFilters.pass
        sb.Append(" WHERE pword  =  @pword")
          
      Case WhereFilters.PrimaryKey
        sb.Append(" WHERE wtid = @wtid And waiter = @waiter")
          
      Case WhereFilters.pword
        sb.Append(" WHERE pword = @pword")
          
      Case WhereFilters.waiter
        sb.Append(" WHERE waiter = @waiter")
...
#Region "WhereClauseFillInParameters Method"
  ...
  Protected Overrides Sub WhereClauseFillInParameters()
    Select Case WhereFilter
      Case WhereFilters.pass
        CommandObject.Parameters.Add(DataProvider.CreateParameter("pword", DbType.String, Entity.pword))
      Case WhereFilters.PrimaryKey
        CommandObject.Parameters.Add(DataProvider.CreateParameter("wtid", DbType.Int32, Entity.wtid))
        CommandObject.Parameters.Add(DataProvider.CreateParameter("waiter", DbType.String, Entity.waiter))
      Case WhereFilters.pword
        CommandObject.Parameters.Add(DataProvider.CreateParameter("pword", DbType.String, Entity.pword))
      Case WhereFilters.waiter
        CommandObject.Parameters.Add(DataProvider.CreateParameter("waiter", DbType.String, Entity.waiter))
...
#Region "OrderByClauseSQL Method"
  ...
  Public Overrides Function OrderByClauseSQL() As String
    ...
    Select Case OrderByFilter
      ...
      Case OrderByFilters.pword
          sb.Append(" ORDER BY pword")
...
#Region "PrimaryKeySet Method"
  ...
  Public Overrides Sub PrimaryKeySet(ByVal wtid As Integer)
    ' Fill in Entity Values
    Entity.wtid = wtid
    ' Fill in Columns Collection
    ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.wtid).Value = wtid
  End Sub
#End Region
    ...
    Select Case DataModificationAction
      Case PDSADataModificationState.Delete
        Select Case DeleteFilter
          ...
          Case DeleteFilters.DeleteByPK
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@wtid", DbType.Int32, ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.wtid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@waiter", DbType.String, ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.waiter).Value))
      ...
      Case PDSADataModificationState.Insert
        ...
        Select Case InsertFilter
          Case InsertFilters.All
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@waiter", DbType.String, ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.waiter).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@pword", DbType.String, ValidatorObject.Properties.GetByName(waitersValidator.ColumnNames.pword).Value))
