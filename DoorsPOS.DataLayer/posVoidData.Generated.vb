...
#Region "Constructors"
  ...
  Public Sub New()
    ...
    _Entity = New posVoid()
    ValidatorObject = New posVoidValidator(_Entity)
  ...
  ''' <param name="entity">An instance of a posVoid</param>
  Public Sub New(ByVal dataProvider As PDSADataProvider, ByVal entity As posVoid)
  ...
  Public Sub New(ByVal dataProvider As PDSADataProvider, _
    ByVal entity As posVoid, ByVal validator As posVoidValidator)
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ClassName = "posVoidData"
    DBObjectName = "posVoid"
    SchemaName = "dbo"
...
#Region "InitDataColumns Method"
  ...
  Protected Overrides Sub InitDataColumns()
    ...
    prop = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.voidid)
    ...
    prop = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.stckid)
    ...
    prop = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.barcode)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.itemdesc)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.cost)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.price)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlMoney.Null
    ...
    prop = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.pckqty)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.qty)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.sInsertid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlString.Null
    ...
    prop = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.dtInsertdt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
...
#Region "EntityDataToColumnCollection Method"
  ...
  Protected Overrides Sub EntityDataToColumnCollection()
    ...
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.voidid).Value = Entity.voidid
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.stckid).Value = Entity.stckid
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.barcode).Value = Entity.barcode
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.itemdesc).Value = Entity.itemdesc
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.cost).Value = Entity.cost
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.price).Value = Entity.price
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.pckqty).Value = Entity.pckqty
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.qty).Value = Entity.qty
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.sInsertid).Value = Entity.sInsertid
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.dtInsertdt).Value = Entity.dtInsertdt
  End Sub
#End Region
...
#Region "ColumnCollectionToEntityData Method"
  ...
  Protected Overrides Sub ColumnCollectionToEntityData()
    If ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.voidid).IsNull = False Then
      Entity.voidid = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.voidid).GetAsInteger()
    Else
      Entity.voidid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.stckid).IsNull = False Then
      Entity.stckid = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.stckid).GetAsInteger()
    Else
      Entity.stckid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.barcode).IsNull = False Then
      Entity.barcode = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.barcode).GetAsString()
    Else
      Entity.barcode = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.itemdesc).IsNull = False Then
      Entity.itemdesc = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.itemdesc).GetAsString()
    Else
      Entity.itemdesc = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.cost).IsNull = False Then
      Entity.cost = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.cost).GetAsDecimal()
    Else
      Entity.cost = 0
    End If
    
    If ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.price).IsNull = False Then
      Entity.price = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.price).GetAsDecimal()
    Else
      Entity.price = 0
    End If
    
    If ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.pckqty).IsNull = False Then
      Entity.pckqty = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.pckqty).GetAsInteger()
    Else
      Entity.pckqty = 0
    End If
    
    If ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.qty).IsNull = False Then
      Entity.qty = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.qty).GetAsDouble()
    Else
      Entity.qty = 0
    End If
    
    If ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.sInsertid).IsNull = False Then
      Entity.sInsertid = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.sInsertid).GetAsString()
    Else
      Entity.sInsertid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.dtInsertdt).IsNull = False Then
      Entity.dtInsertdt = ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.dtInsertdt).GetAsDate()
    Else
...
#Region "CreateEntityFromDataRow Method"
  ...
  Public Function CreateEntityFromDataRow(ByVal dr As DataRow) As posVoid
    ...
    Select Case SelectFilter
      Case SelectFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT voidid, stckid, barcode, item_desc, cost, price, pck_qty, qty, sInsert_id, dtInsert_dt FROM dbo.posVoid")
      ...
      Case SelectFilters.ListBox
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT voidid, barcode FROM dbo.posVoid")
      ...
      Case SelectFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT voidid, stckid, barcode, item_desc, cost, price, pck_qty, qty, sInsert_id, dtInsert_dt FROM dbo.posVoid WHERE voidid = @voidid")
    ...
    Select Case InsertFilter
      Case InsertFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" INSERT INTO dbo.posVoid ( stckid, barcode, item_desc, cost, price, pck_qty, qty, sInsert_id, dtInsert_dt ) VALUES ( @stckid, @barcode, @itemdesc, @cost, @price, @pckqty, @qty, @sInsertid, @dtInsertdt )")
    ...
    Select Case UpdateFilter
      Case UpdateFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" UPDATE dbo.posVoid SET stckid = @stckid, barcode = @barcode, item_desc = @itemdesc, cost = @cost, price = @price, pck_qty = @pckqty, qty = @qty, sInsert_id = @sInsertid, dtInsert_dt = @dtInsertdt WHERE voidid = @voidid")
...
#Region "DeleteByPK Method"
  ...
  ''' <returns>int</returns>
  Public Function DeleteByPK(ByVal voidid As Integer) As Integer
    DeleteFilter = DeleteFilters.DeleteByPK
    Entity.voidid = voidid
    ...
    Select Case DeleteFilter
      Case DeleteFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.posVoid")
      ...
      Case DeleteFilters.DeleteByPK
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.posVoid WHERE voidid = @voidid")
    ...
    Select Case RowCountFilter
      Case RowCountFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT Count(*) As NumRecs FROM dbo.posVoid")
...
#Region "LoadByPK Method"
  ...
  Public Function LoadByPK(ByVal voidid As Integer) As Integer
...
#Region "WhereClauseFillInParameters Method"
  ...
  Protected Overrides Sub WhereClauseFillInParameters()
    Select Case WhereFilter
      Case WhereFilters.PrimaryKey
        CommandObject.Parameters.Add(DataProvider.CreateParameter("voidid", DbType.Int32, Entity.voidid))
      Case WhereFilters.barcode
...
#Region "PrimaryKeySet Method"
  ...
  Public Overrides Sub PrimaryKeySet(ByVal voidid As Integer)
    ' Fill in Entity Values
    Entity.voidid = voidid
    ' Fill in Columns Collection
    ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.voidid).Value = voidid
  End Sub
#End Region
    ...
    Select Case DataModificationAction
      Case PDSADataModificationState.Delete
        Select Case DeleteFilter
          ...
          Case DeleteFilters.DeleteByPK
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@voidid", DbType.Int32, ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.voidid).Value))
      ...
      Case PDSADataModificationState.Insert
        ...
        Select Case InsertFilter
          Case InsertFilters.All
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@stckid", DbType.Int32, ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.stckid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@barcode", DbType.String, ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.barcode).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@itemdesc", DbType.String, ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.itemdesc).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@cost", DbType.Decimal, ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.cost).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@price", DbType.Decimal, ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.price).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@pckqty", DbType.Decimal, ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.pckqty).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@qty", DbType.Double, ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.qty).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sInsertid", DbType.String, ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.sInsertid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtInsertdt", DbType.DateTime, ValidatorObject.Properties.GetByName(posVoidValidator.ColumnNames.dtInsertdt).Value))
