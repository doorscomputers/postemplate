...
''' </summary>
Partial Public Class spReplaceProcManager
...
#Region "Private Variables"
  ...
  Private _DataObject As spReplaceProcData
#End Region
...
#Region "Public Properties"
  ...
  ''' </summary>
  Public Property DataObject() As spReplaceProcData
    Get
      Return _DataObject
    End Get
    Set(ByVal value As spReplaceProcData)
      _DataObject = value
    End Set
  End Property
#End Region
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ...
    If Entity Is Nothing Then
      Entity = New spReplaceProc()
    End If
    
    ' Create Data Class if not Created
    If DataObject Is Nothing Then
      DataObject = New spReplaceProcData(DataProvider, Entity)
    End If

    ClassName = "spReplaceProcManager"
  End Sub
#End Region
End Class
