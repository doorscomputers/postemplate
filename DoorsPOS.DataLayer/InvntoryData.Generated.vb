...
#Region "Constructors"
  ...
  Public Sub New()
    ...
    _Entity = New Invntory()
    ValidatorObject = New InvntoryValidator(_Entity)
  ...
  ''' <param name="entity">An instance of a Invntory</param>
  Public Sub New(ByVal dataProvider As PDSADataProvider, ByVal entity As Invntory)
  ...
  Public Sub New(ByVal dataProvider As PDSADataProvider, _
    ByVal entity As Invntory, ByVal validator As InvntoryValidator)
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ClassName = "InvntoryData"
    DBObjectName = "Invntory"
    SchemaName = "dbo"
...
#Region "InitDataColumns Method"
  ...
  Protected Overrides Sub InitDataColumns()
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.miid)
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.midate)
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.stckid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlInt32.Null
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.qty)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlInt32.Null
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.amnt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.prevavlbl)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlInt32.Null
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.sInsertid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.dtInsertdt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlDateTime.Null
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.sLastUpdateid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlString.Null
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.dtLastUpdatedt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlDateTime.Null
    ...
    prop = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.iConcurrencyid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
...
#Region "EntityDataToColumnCollection Method"
  ...
  Protected Overrides Sub EntityDataToColumnCollection()
    ...
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.miid).Value = Entity.miid
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.midate).Value = Entity.midate
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.stckid).Value = Entity.stckid
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.qty).Value = Entity.qty
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.amnt).Value = Entity.amnt
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.prevavlbl).Value = Entity.prevavlbl
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.sInsertid).Value = Entity.sInsertid
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.dtInsertdt).Value = Entity.dtInsertdt
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.sLastUpdateid).Value = Entity.sLastUpdateid
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.dtLastUpdatedt).Value = Entity.dtLastUpdatedt
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.iConcurrencyid).Value = Entity.iConcurrencyid
  End Sub
#End Region
...
#Region "ColumnCollectionToEntityData Method"
  ...
  Protected Overrides Sub ColumnCollectionToEntityData()
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.miid).IsNull = False Then
      Entity.miid = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.miid).GetAsInteger()
    Else
      Entity.miid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.midate).IsNull = False Then
      Entity.midate = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.midate).GetAsDate()
    Else
      Entity.midate = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.stckid).IsNull = False Then
      Entity.stckid = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.stckid).GetAsInteger()
    Else
      Entity.stckid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.qty).IsNull = False Then
      Entity.qty = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.qty).GetAsInteger()
    Else
      Entity.qty = 0
    End If
    
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.amnt).IsNull = False Then
      Entity.amnt = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.amnt).GetAsDecimal()
    Else
      Entity.amnt = 0
    End If
    
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.prevavlbl).IsNull = False Then
      Entity.prevavlbl = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.prevavlbl).GetAsInteger()
    Else
      Entity.prevavlbl = 0
    End If
    
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.sInsertid).IsNull = False Then
      Entity.sInsertid = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.sInsertid).GetAsString()
    Else
      Entity.sInsertid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.dtInsertdt).IsNull = False Then
      Entity.dtInsertdt = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.dtInsertdt).GetAsDate()
    Else
      Entity.dtInsertdt = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.sLastUpdateid).IsNull = False Then
      Entity.sLastUpdateid = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.sLastUpdateid).GetAsString()
    Else
      Entity.sLastUpdateid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.dtLastUpdatedt).IsNull = False Then
      Entity.dtLastUpdatedt = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.dtLastUpdatedt).GetAsDate()
    Else
      Entity.dtLastUpdatedt = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.iConcurrencyid).IsNull = False Then
      Entity.iConcurrencyid = ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.iConcurrencyid).GetAsShort()
    Else
...
#Region "CreateEntityFromDataRow Method"
  ...
  Public Function CreateEntityFromDataRow(ByVal dr As DataRow) As Invntory
    ...
    Select Case SelectFilter
      Case SelectFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT miid, midate, stckid, qty, amnt, prevavlbl, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id FROM dbo.Invntory")
      ...
      Case SelectFilters.ListBox
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT miid, sInsert_id FROM dbo.Invntory")
      ...
      Case SelectFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT miid, midate, stckid, qty, amnt, prevavlbl, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id FROM dbo.Invntory WHERE miid = @miid")
    ...
    Select Case InsertFilter
      Case InsertFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" INSERT INTO dbo.Invntory ( midate, stckid, qty, amnt, prevavlbl, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id ) VALUES ( @midate, @stckid, @qty, @amnt, @prevavlbl, @sInsertid, @dtInsertdt, @sLastUpdateid, @dtLastUpdatedt, @iConcurrencyid )")
    ...
    Select Case UpdateFilter
      Case UpdateFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" UPDATE dbo.Invntory SET midate = @midate, stckid = @stckid, qty = @qty, amnt = @amnt, prevavlbl = @prevavlbl, sInsert_id = @sInsertid, dtInsert_dt = @dtInsertdt, sLastUpdate_id = @sLastUpdateid, dtLastUpdate_dt = @dtLastUpdatedt, iConcurrency_id = @iConcurrencyid WHERE miid = @miid")
...
#Region "DeleteByPK Method"
  ...
  ''' <returns>int</returns>
  Public Function DeleteByPK(ByVal miid As Integer) As Integer
    ...
    Select Case DeleteFilter
      Case DeleteFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.Invntory")
      ...
      Case DeleteFilters.DeleteByPK
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.Invntory WHERE miid = @miid")
    ...
    Select Case RowCountFilter
      Case RowCountFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT Count(*) As NumRecs FROM dbo.Invntory")
...
#Region "LoadByPK Method"
  ...
  Public Function LoadByPK(ByVal miid As Integer) As Integer
...
#Region "WhereClauseFillInParameters Method"
  ...
  Protected Overrides Sub WhereClauseFillInParameters()
    Select Case WhereFilter
      Case WhereFilters.PrimaryKey
        CommandObject.Parameters.Add(DataProvider.CreateParameter("miid", DbType.Int32, Entity.miid))
      Case WhereFilters.sInsert_id
...
#Region "PrimaryKeySet Method"
  ...
  Public Overrides Sub PrimaryKeySet(ByVal miid As Integer)
    ' Fill in Entity Values
    Entity.miid = miid
    ' Fill in Columns Collection
    ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.miid).Value = miid
  End Sub
#End Region
    ...
    Select Case DataModificationAction
      Case PDSADataModificationState.Delete
        Select Case DeleteFilter
          ...
          Case DeleteFilters.DeleteByPK
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@miid", DbType.Int32, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.miid).Value))
      ...
      Case PDSADataModificationState.Insert
        ...
        Select Case InsertFilter
          Case InsertFilters.All
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@midate", DbType.Date, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.midate).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@stckid", DbType.Int32, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.stckid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@qty", DbType.Int32, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.qty).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@amnt", DbType.Decimal, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.amnt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@prevavlbl", DbType.Int32, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.prevavlbl).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sInsertid", DbType.String, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.sInsertid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtInsertdt", DbType.DateTime, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.dtInsertdt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sLastUpdateid", DbType.String, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.sLastUpdateid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtLastUpdatedt", DbType.DateTime, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.dtLastUpdatedt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@iConcurrencyid", DbType.Int16, ValidatorObject.Properties.GetByName(InvntoryValidator.ColumnNames.iConcurrencyid).Value))
