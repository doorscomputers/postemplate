...
''' </summary>
Partial Public Class spSearchItemsManager
...
#Region "Private Variables"
  ...
  Private _DataObject As spSearchItemsData
#End Region
...
#Region "Public Properties"
  ...
  ''' </summary>
  Public Property DataObject() As spSearchItemsData
    Get
      Return _DataObject
    End Get
    Set(ByVal value As spSearchItemsData)
      _DataObject = value
    End Set
  End Property
#End Region
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ...
    If Entity Is Nothing Then
      Entity = New spSearchItems()
    End If
    
    ' Create Data Class if not Created
    If DataObject Is Nothing Then
      DataObject = New spSearchItemsData(DataProvider, Entity)
    End If

    ClassName = "spSearchItemsManager"
  End Sub
#End Region
End Class
