...
#Region "Constructors"
  ...
  Public Sub New()
    ...
    _Entity = New transfer_hdr()
    ValidatorObject = New transfer_hdrValidator(_Entity)
  ...
  ''' <param name="entity">An instance of a transfer_hdr</param>
  Public Sub New(ByVal dataProvider As PDSADataProvider, ByVal entity As transfer_hdr)
  ...
  Public Sub New(ByVal dataProvider As PDSADataProvider, _
    ByVal entity As transfer_hdr, ByVal validator As transfer_hdrValidator)
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ClassName = "transfer_hdrData"
    DBObjectName = "transfer_hdr"
    SchemaName = "dbo"
...
#Region "InitDataColumns Method"
  ...
  Protected Overrides Sub InitDataColumns()
    ...
    prop = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tid)
    ...
    prop = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.TransferNo)
    ...
    prop = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tdate)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tamnt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.locid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlInt32.Null
    ...
    prop = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.sInsertid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.dtInsertdt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlDateTime.Null
    ...
    prop = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.sLastUpdateid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlChars.Null
    ...
    prop = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.dtLastUpdatedt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlDateTime.Null
    ...
    prop = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.iConcurrencyid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
...
#Region "EntityDataToColumnCollection Method"
  ...
  Protected Overrides Sub EntityDataToColumnCollection()
    ...
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tid).Value = Entity.tid
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.TransferNo).Value = Entity.TransferNo
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tdate).Value = Entity.tdate
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tamnt).Value = Entity.tamnt
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.locid).Value = Entity.locid
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.sInsertid).Value = Entity.sInsertid
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.dtInsertdt).Value = Entity.dtInsertdt
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.sLastUpdateid).Value = Entity.sLastUpdateid
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.dtLastUpdatedt).Value = Entity.dtLastUpdatedt
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.iConcurrencyid).Value = Entity.iConcurrencyid
  End Sub
#End Region
...
#Region "ColumnCollectionToEntityData Method"
  ...
  Protected Overrides Sub ColumnCollectionToEntityData()
    If ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tid).IsNull = False Then
      Entity.tid = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tid).GetAsInteger()
    Else
      Entity.tid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.TransferNo).IsNull = False Then
      Entity.TransferNo = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.TransferNo).GetAsInteger()
    Else
      Entity.TransferNo = 0
    End If
    
    If ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tdate).IsNull = False Then
      Entity.tdate = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tdate).GetAsDate()
    Else
      Entity.tdate = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tamnt).IsNull = False Then
      Entity.tamnt = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tamnt).GetAsDecimal()
    Else
      Entity.tamnt = 0
    End If
    
    If ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.locid).IsNull = False Then
      Entity.locid = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.locid).GetAsInteger()
    Else
      Entity.locid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.sInsertid).IsNull = False Then
      Entity.sInsertid = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.sInsertid).GetAsString()
    Else
      Entity.sInsertid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.dtInsertdt).IsNull = False Then
      Entity.dtInsertdt = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.dtInsertdt).GetAsDate()
    Else
      Entity.dtInsertdt = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.sLastUpdateid).IsNull = False Then
      Entity.sLastUpdateid = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.sLastUpdateid).GetAsString()
    Else
      Entity.sLastUpdateid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.dtLastUpdatedt).IsNull = False Then
      Entity.dtLastUpdatedt = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.dtLastUpdatedt).GetAsDate()
    Else
      Entity.dtLastUpdatedt = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.iConcurrencyid).IsNull = False Then
      Entity.iConcurrencyid = ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.iConcurrencyid).GetAsShort()
    Else
...
#Region "CreateEntityFromDataRow Method"
  ...
  Public Function CreateEntityFromDataRow(ByVal dr As DataRow) As transfer_hdr
    ...
    Select Case SelectFilter
      Case SelectFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT tid, TransferNo, tdate, tamnt, locid, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id FROM dbo.transfer_hdr")
      ...
      Case SelectFilters.ListBox
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT tid, sInsert_id FROM dbo.transfer_hdr")
    ...
    Select Case InsertFilter
      Case InsertFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" INSERT INTO dbo.transfer_hdr ( TransferNo, tdate, tamnt, locid, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id ) VALUES ( @TransferNo, @tdate, @tamnt, @locid, @sInsertid, @dtInsertdt, @sLastUpdateid, @dtLastUpdatedt, @iConcurrencyid )")
    ...
    Select Case UpdateFilter
      Case UpdateFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" UPDATE dbo.transfer_hdr SET TransferNo = @TransferNo, tdate = @tdate, tamnt = @tamnt, locid = @locid, sInsert_id = @sInsertid, dtInsert_dt = @dtInsertdt, sLastUpdate_id = @sLastUpdateid, dtLastUpdate_dt = @dtLastUpdatedt, iConcurrency_id = @iConcurrencyid WHERE tid = @tid")
...
#Region "DeleteByPK Method"
  ...
  ''' <returns>int</returns>
  Public Function DeleteByPK(ByVal tid As Integer) As Integer
    ...
    Select Case DeleteFilter
      Case DeleteFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.transfer_hdr")
      ...
      Case DeleteFilters.DeleteByPK
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.transfer_hdr WHERE tid = @tid")
    ...
    Select Case RowCountFilter
      Case RowCountFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT Count(*) As NumRecs FROM dbo.transfer_hdr")
...
#Region "LoadByPK Method"
  ...
  Public Function LoadByPK(ByVal tid As Integer) As Integer
...
#Region "PrimaryKeySet Method"
  ...
  Public Overrides Sub PrimaryKeySet(ByVal tid As Integer)
    ' Fill in Entity Values
    Entity.tid = tid
    ' Fill in Columns Collection
    ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tid).Value = tid
  End Sub
#End Region
    ...
    Select Case DataModificationAction
      Case PDSADataModificationState.Delete
        Select Case DeleteFilter
          ...
          Case DeleteFilters.DeleteByPK
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@tid", DbType.Int32, ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tid).Value))
      ...
      Case PDSADataModificationState.Insert
        ...
        Select Case InsertFilter
          Case InsertFilters.All
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@TransferNo", DbType.Int32, ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.TransferNo).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@tdate", DbType.Date, ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tdate).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@tamnt", DbType.Decimal, ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.tamnt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@locid", DbType.Int32, ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.locid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sInsertid", DbType.String, ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.sInsertid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtInsertdt", DbType.Date, ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.dtInsertdt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sLastUpdateid", DbType.String, ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.sLastUpdateid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtLastUpdatedt", DbType.Date, ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.dtLastUpdatedt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@iConcurrencyid", DbType.Int16, ValidatorObject.Properties.GetByName(transfer_hdrValidator.ColumnNames.iConcurrencyid).Value))
