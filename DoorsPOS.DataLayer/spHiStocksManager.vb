...
''' </summary>
Partial Public Class spHiStocksManager
...
#Region "Private Variables"
  ...
  Private _DataObject As spHiStocksData
#End Region
...
#Region "Public Properties"
  ...
  ''' </summary>
  Public Property DataObject() As spHiStocksData
    Get
      Return _DataObject
    End Get
    Set(ByVal value As spHiStocksData)
      _DataObject = value
    End Set
  End Property
#End Region
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ...
    If Entity Is Nothing Then
      Entity = New spHiStocks()
    End If
    
    ' Create Data Class if not Created
    If DataObject Is Nothing Then
      DataObject = New spHiStocksData(DataProvider, Entity)
    End If

    ClassName = "spHiStocksManager"
  End Sub
#End Region
End Class
