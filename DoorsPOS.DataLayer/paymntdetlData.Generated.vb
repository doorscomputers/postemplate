...
#Region "Constructors"
  ...
  Public Sub New()
    ...
    _Entity = New paymntdetl()
    ValidatorObject = New paymntdetlValidator(_Entity)
  ...
  ''' <param name="entity">An instance of a paymntdetl</param>
  Public Sub New(ByVal dataProvider As PDSADataProvider, ByVal entity As paymntdetl)
  ...
  Public Sub New(ByVal dataProvider As PDSADataProvider, _
    ByVal entity As paymntdetl, ByVal validator As paymntdetlValidator)
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ClassName = "paymntdetlData"
    DBObjectName = "paymntdetl"
    SchemaName = "dbo"
...
#Region "InitDataColumns Method"
  ...
  Protected Overrides Sub InitDataColumns()
    ...
    prop = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.pmntdetid)
    ...
    prop = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.payid)
    ...
    prop = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.drinv)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.drid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlInt32.Null
    ...
    prop = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.amnt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.remarks)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlChars.Null
...
#Region "EntityDataToColumnCollection Method"
  ...
  Protected Overrides Sub EntityDataToColumnCollection()
    ...
    ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.pmntdetid).Value = Entity.pmntdetid
    ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.payid).Value = Entity.payid
    ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.drinv).Value = Entity.drinv
    ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.drid).Value = Entity.drid
    ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.amnt).Value = Entity.amnt
    ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.remarks).Value = Entity.remarks
  End Sub
#End Region
...
#Region "ColumnCollectionToEntityData Method"
  ...
  Protected Overrides Sub ColumnCollectionToEntityData()
    If ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.pmntdetid).IsNull = False Then
      Entity.pmntdetid = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.pmntdetid).GetAsInteger()
    Else
      Entity.pmntdetid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.payid).IsNull = False Then
      Entity.payid = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.payid).GetAsInteger()
    Else
      Entity.payid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.drinv).IsNull = False Then
      Entity.drinv = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.drinv).GetAsString()
    Else
      Entity.drinv = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.drid).IsNull = False Then
      Entity.drid = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.drid).GetAsInteger()
    Else
      Entity.drid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.amnt).IsNull = False Then
      Entity.amnt = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.amnt).GetAsDecimal()
    Else
      Entity.amnt = 0
    End If
    
    If ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.remarks).IsNull = False Then
      Entity.remarks = ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.remarks).GetAsString()
    Else
...
#Region "CreateEntityFromDataRow Method"
  ...
  Public Function CreateEntityFromDataRow(ByVal dr As DataRow) As paymntdetl
    ...
    Select Case SelectFilter
      Case SelectFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT pmntdetid, payid, drinv, drid, amnt, remarks FROM dbo.paymntdetl")
      ...
      Case SelectFilters.ListBox
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT pmntdetid, drinv FROM dbo.paymntdetl")
      ...
      Case SelectFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT pmntdetid, payid, drinv, drid, amnt, remarks FROM dbo.paymntdetl WHERE pmntdetid = @pmntdetid")
    ...
    Select Case InsertFilter
      Case InsertFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" INSERT INTO dbo.paymntdetl ( payid, drinv, drid, amnt, remarks ) VALUES ( @payid, @drinv, @drid, @amnt, @remarks )")
    ...
    Select Case UpdateFilter
      Case UpdateFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" UPDATE dbo.paymntdetl SET payid = @payid, drinv = @drinv, drid = @drid, amnt = @amnt, remarks = @remarks WHERE pmntdetid = @pmntdetid")
...
#Region "DeleteByPK Method"
  ...
  ''' <returns>int</returns>
  Public Function DeleteByPK(ByVal pmntdetid As Integer) As Integer
    DeleteFilter = DeleteFilters.DeleteByPK
    Entity.pmntdetid = pmntdetid
    ...
    Select Case DeleteFilter
      Case DeleteFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.paymntdetl")
      ...
      Case DeleteFilters.DeleteByPK
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.paymntdetl WHERE pmntdetid = @pmntdetid")
    ...
    Select Case RowCountFilter
      Case RowCountFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT Count(*) As NumRecs FROM dbo.paymntdetl")
...
#Region "LoadByPK Method"
  ...
  Public Function LoadByPK(ByVal pmntdetid As Integer) As Integer
  ...
  Public Overrides Function WhereClauseSQL() As String
    ...
    Select Case WhereFilter
      ...
      Case WhereFilters.PrimaryKey
        sb.Append(" WHERE pmntdetid = @pmntdetid")
  ...
  Protected Overrides Sub WhereClauseFillInParameters()
    Select Case WhereFilter
      ...
      Case WhereFilters.Likedrinv
        CommandObject.Parameters.Add(DataProvider.CreateParameter("drinv", DbType.String, Entity.drinv))
      Case WhereFilters.PrimaryKey
        CommandObject.Parameters.Add(DataProvider.CreateParameter("pmntdetid", DbType.Int32, Entity.pmntdetid))
...
#Region "PrimaryKeySet Method"
  ...
  Public Overrides Sub PrimaryKeySet(ByVal pmntdetid As Integer)
    ' Fill in Entity Values
    Entity.pmntdetid = pmntdetid
    ' Fill in Columns Collection
    ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.pmntdetid).Value = pmntdetid
  End Sub
#End Region
    ...
    Select Case DataModificationAction
      Case PDSADataModificationState.Delete
        Select Case DeleteFilter
          ...
          Case DeleteFilters.DeleteByPK
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@pmntdetid", DbType.Int32, ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.pmntdetid).Value))
      ...
      Case PDSADataModificationState.Insert
        ...
        Select Case InsertFilter
          Case InsertFilters.All
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@payid", DbType.Int32, ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.payid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@drinv", DbType.String, ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.drinv).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@drid", DbType.Int32, ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.drid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@amnt", DbType.Decimal, ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.amnt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@remarks", DbType.String, ValidatorObject.Properties.GetByName(paymntdetlValidator.ColumnNames.remarks).Value))
