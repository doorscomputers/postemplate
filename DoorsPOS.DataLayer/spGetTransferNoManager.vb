...
''' </summary>
Partial Public Class spGetTransferNoManager
...
#Region "Private Variables"
  ...
  Private _DataObject As spGetTransferNoData
#End Region
...
#Region "Public Properties"
  ...
  ''' </summary>
  Public Property DataObject() As spGetTransferNoData
    Get
      Return _DataObject
    End Get
    Set(ByVal value As spGetTransferNoData)
      _DataObject = value
    End Set
  End Property
#End Region
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ...
    If Entity Is Nothing Then
      Entity = New spGetTransferNo()
    End If
    
    ' Create Data Class if not Created
    If DataObject Is Nothing Then
      DataObject = New spGetTransferNoData(DataProvider, Entity)
    End If

    ClassName = "spGetTransferNoManager"
  End Sub
#End Region
End Class
