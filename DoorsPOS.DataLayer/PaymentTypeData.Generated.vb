...
#Region "Constructors"
  ...
  Public Sub New()
    ...
    _Entity = New PaymentType()
    ValidatorObject = New PaymentTypeValidator(_Entity)
  ...
  ''' <param name="entity">An instance of a PaymentType</param>
  Public Sub New(ByVal dataProvider As PDSADataProvider, ByVal entity As PaymentType)
  ...
  Public Sub New(ByVal dataProvider As PDSADataProvider, _
    ByVal entity As PaymentType, ByVal validator As PaymentTypeValidator)
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ClassName = "PaymentTypeData"
    DBObjectName = "PaymentType"
    SchemaName = "dbo"
...
#Region "InitDataColumns Method"
  ...
  Protected Overrides Sub InitDataColumns()
    ...
    prop = ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.paytypeid)
    ...
    prop = ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.PaymentType)
...
#Region "EntityDataToColumnCollection Method"
  ...
  Protected Overrides Sub EntityDataToColumnCollection()
    ...
    ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.paytypeid).Value = Entity.paytypeid
    ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.PaymentType).Value = Entity.PaymentType
  End Sub
#End Region
...
#Region "ColumnCollectionToEntityData Method"
  ...
  Protected Overrides Sub ColumnCollectionToEntityData()
    If ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.paytypeid).IsNull = False Then
      Entity.paytypeid = ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.paytypeid).GetAsInteger()
    Else
      Entity.paytypeid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.PaymentType).IsNull = False Then
      Entity.PaymentType = ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.PaymentType).GetAsString()
    Else
...
#Region "CreateEntityFromDataRow Method"
  ...
  Public Function CreateEntityFromDataRow(ByVal dr As DataRow) As PaymentType
    ...
    Select Case SelectFilter
      Case SelectFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT paytypeid, PaymentType FROM dbo.PaymentType")
      ...
      Case SelectFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT paytypeid, PaymentType FROM dbo.PaymentType WHERE paytypeid = @paytypeid")
    ...
    Select Case InsertFilter
      Case InsertFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" INSERT INTO dbo.PaymentType ( PaymentType ) VALUES ( @PaymentType )")
    ...
    Select Case UpdateFilter
      Case UpdateFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" UPDATE dbo.PaymentType SET PaymentType = @PaymentType WHERE paytypeid = @paytypeid")
...
#Region "DeleteByPK Method"
  ...
  ''' <returns>int</returns>
  Public Function DeleteByPK(ByVal paytypeid As Integer) As Integer
    ...
    Select Case DeleteFilter
      Case DeleteFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.PaymentType")
      ...
      Case DeleteFilters.DeleteByPK
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.PaymentType WHERE paytypeid = @paytypeid")
    ...
    Select Case RowCountFilter
      Case RowCountFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT Count(*) As NumRecs FROM dbo.PaymentType")
...
#Region "LoadByPK Method"
  ...
  Public Function LoadByPK(ByVal paytypeid As Integer) As Integer
  ...
  Public Overrides Function WhereClauseSQL() As String
    ...
    Select Case WhereFilter
      ...
      Case WhereFilters.PrimaryKey
        sb.Append(" WHERE paytypeid = @paytypeid")
          
      Case WhereFilters.PaymentType
        sb.Append(" WHERE PaymentType = @PaymentType")
          
      Case WhereFilters.LikePaymentType
        sb.Append(" WHERE PaymentType LIKE @PaymentType")
...
#Region "WhereClauseFillInParameters Method"
  ...
  Protected Overrides Sub WhereClauseFillInParameters()
    Select Case WhereFilter
      Case WhereFilters.PrimaryKey
        CommandObject.Parameters.Add(DataProvider.CreateParameter("paytypeid", DbType.Int32, Entity.paytypeid))
      Case WhereFilters.PaymentType
        CommandObject.Parameters.Add(DataProvider.CreateParameter("PaymentType", DbType.String, Entity.PaymentType))
      Case WhereFilters.LikePaymentType
        CommandObject.Parameters.Add(DataProvider.CreateParameter("PaymentType", DbType.String, Entity.PaymentType))
...
#Region "OrderByClauseSQL Method"
  ...
  Public Overrides Function OrderByClauseSQL() As String
    ...
    Select Case OrderByFilter
      ...
      Case OrderByFilters.PaymentType
          sb.Append(" ORDER BY PaymentType")
...
#Region "PrimaryKeySet Method"
  ...
  Public Overrides Sub PrimaryKeySet(ByVal paytypeid As Integer)
    ' Fill in Entity Values
    Entity.paytypeid = paytypeid
    ' Fill in Columns Collection
    ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.paytypeid).Value = paytypeid
  End Sub
#End Region
    ...
    Select Case DataModificationAction
      Case PDSADataModificationState.Delete
        Select Case DeleteFilter
          ...
          Case DeleteFilters.DeleteByPK
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@paytypeid", DbType.Int32, ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.paytypeid).Value))
      ...
      Case PDSADataModificationState.Insert
        ...
        Select Case InsertFilter
          Case InsertFilters.All
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@PaymentType", DbType.String, ValidatorObject.Properties.GetByName(PaymentTypeValidator.ColumnNames.PaymentType).Value))
