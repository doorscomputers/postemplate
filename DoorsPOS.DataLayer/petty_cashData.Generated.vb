...
#Region "Constructors"
  ...
  Public Sub New()
    ...
    _Entity = New petty_cash()
    ValidatorObject = New petty_cashValidator(_Entity)
  ...
  ''' <param name="entity">An instance of a petty_cash</param>
  Public Sub New(ByVal dataProvider As PDSADataProvider, ByVal entity As petty_cash)
  ...
  Public Sub New(ByVal dataProvider As PDSADataProvider, _
    ByVal entity As petty_cash, ByVal validator As petty_cashValidator)
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ClassName = "petty_cashData"
    DBObjectName = "petty_cash"
    SchemaName = "dbo"
...
#Region "InitDataColumns Method"
  ...
  Protected Overrides Sub InitDataColumns()
    ...
    prop = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcid)
    ...
    prop = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.posdate)
    ...
    prop = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcamnt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcrem)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.cashier)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlString.Null
    ...
    prop = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.sInsertid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlString.Null
    ...
    prop = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.dtInsertdt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlDateTime.Null
    ...
    prop = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.sLastUpdateid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlString.Null
    ...
    prop = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.dtLastUpdatedt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlDateTime.Null
    ...
    prop = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.iConcurrencyid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
...
#Region "EntityDataToColumnCollection Method"
  ...
  Protected Overrides Sub EntityDataToColumnCollection()
    ...
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcid).Value = Entity.pcid
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.posdate).Value = Entity.posdate
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcamnt).Value = Entity.pcamnt
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcrem).Value = Entity.pcrem
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.cashier).Value = Entity.cashier
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.sInsertid).Value = Entity.sInsertid
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.dtInsertdt).Value = Entity.dtInsertdt
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.sLastUpdateid).Value = Entity.sLastUpdateid
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.dtLastUpdatedt).Value = Entity.dtLastUpdatedt
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.iConcurrencyid).Value = Entity.iConcurrencyid
  End Sub
#End Region
...
#Region "ColumnCollectionToEntityData Method"
  ...
  Protected Overrides Sub ColumnCollectionToEntityData()
    If ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcid).IsNull = False Then
      Entity.pcid = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcid).GetAsInteger()
    Else
      Entity.pcid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.posdate).IsNull = False Then
      Entity.posdate = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.posdate).GetAsDate()
    Else
      Entity.posdate = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcamnt).IsNull = False Then
      Entity.pcamnt = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcamnt).GetAsDecimal()
    Else
      Entity.pcamnt = 0
    End If
    
    If ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcrem).IsNull = False Then
      Entity.pcrem = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcrem).GetAsString()
    Else
      Entity.pcrem = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.cashier).IsNull = False Then
      Entity.cashier = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.cashier).GetAsString()
    Else
      Entity.cashier = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.sInsertid).IsNull = False Then
      Entity.sInsertid = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.sInsertid).GetAsString()
    Else
      Entity.sInsertid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.dtInsertdt).IsNull = False Then
      Entity.dtInsertdt = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.dtInsertdt).GetAsDate()
    Else
      Entity.dtInsertdt = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.sLastUpdateid).IsNull = False Then
      Entity.sLastUpdateid = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.sLastUpdateid).GetAsString()
    Else
      Entity.sLastUpdateid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.dtLastUpdatedt).IsNull = False Then
      Entity.dtLastUpdatedt = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.dtLastUpdatedt).GetAsDate()
    Else
      Entity.dtLastUpdatedt = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.iConcurrencyid).IsNull = False Then
      Entity.iConcurrencyid = ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.iConcurrencyid).GetAsShort()
    Else
...
#Region "CreateEntityFromDataRow Method"
  ...
  Public Function CreateEntityFromDataRow(ByVal dr As DataRow) As petty_cash
    ...
    Select Case SelectFilter
      Case SelectFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT pcid, posdate, pcamnt, pcrem, cashier, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id FROM dbo.petty_cash")
      ...
      Case SelectFilters.ListBox
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT pcid, pcrem FROM dbo.petty_cash")
      ...
      Case SelectFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT pcid, posdate, pcamnt, pcrem, cashier, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id FROM dbo.petty_cash WHERE pcid = @pcid")
    ...
    Select Case InsertFilter
      Case InsertFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" INSERT INTO dbo.petty_cash ( posdate, pcamnt, pcrem, cashier, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id ) VALUES ( @posdate, @pcamnt, @pcrem, @cashier, @sInsertid, @dtInsertdt, @sLastUpdateid, @dtLastUpdatedt, @iConcurrencyid )")
    ...
    Select Case UpdateFilter
      Case UpdateFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" UPDATE dbo.petty_cash SET posdate = @posdate, pcamnt = @pcamnt, pcrem = @pcrem, cashier = @cashier, sInsert_id = @sInsertid, dtInsert_dt = @dtInsertdt, sLastUpdate_id = @sLastUpdateid, dtLastUpdate_dt = @dtLastUpdatedt, iConcurrency_id = @iConcurrencyid WHERE pcid = @pcid")
...
#Region "DeleteByPK Method"
  ...
  ''' <returns>int</returns>
  Public Function DeleteByPK(ByVal pcid As Integer) As Integer
    ...
    Select Case DeleteFilter
      Case DeleteFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.petty_cash")
      ...
      Case DeleteFilters.DeleteByPK
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.petty_cash WHERE pcid = @pcid")
    ...
    Select Case RowCountFilter
      Case RowCountFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT Count(*) As NumRecs FROM dbo.petty_cash")
...
#Region "LoadByPK Method"
  ...
  Public Function LoadByPK(ByVal pcid As Integer) As Integer
  ...
  Public Overrides Function WhereClauseSQL() As String
    ...
    Select Case WhereFilter
      ...
      Case WhereFilters.PrimaryKey
        sb.Append(" WHERE pcid = @pcid")
          
      Case WhereFilters.pcrem
        sb.Append(" WHERE pcrem = @pcrem")
          
      Case WhereFilters.Likepcrem
        sb.Append(" WHERE pcrem LIKE @pcrem")
...
#Region "WhereClauseFillInParameters Method"
  ...
  Protected Overrides Sub WhereClauseFillInParameters()
    Select Case WhereFilter
      Case WhereFilters.PrimaryKey
        CommandObject.Parameters.Add(DataProvider.CreateParameter("pcid", DbType.Int32, Entity.pcid))
      Case WhereFilters.pcrem
        CommandObject.Parameters.Add(DataProvider.CreateParameter("pcrem", DbType.String, Entity.pcrem))
      Case WhereFilters.Likepcrem
        CommandObject.Parameters.Add(DataProvider.CreateParameter("pcrem", DbType.String, Entity.pcrem))
...
#Region "OrderByClauseSQL Method"
  ...
  Public Overrides Function OrderByClauseSQL() As String
    ...
    Select Case OrderByFilter
      ...
      Case OrderByFilters.pcrem
          sb.Append(" ORDER BY pcrem")
...
#Region "PrimaryKeySet Method"
  ...
  Public Overrides Sub PrimaryKeySet(ByVal pcid As Integer)
    ' Fill in Entity Values
    Entity.pcid = pcid
    ' Fill in Columns Collection
    ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcid).Value = pcid
  End Sub
#End Region
    ...
    Select Case DataModificationAction
      Case PDSADataModificationState.Delete
        Select Case DeleteFilter
          ...
          Case DeleteFilters.DeleteByPK
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@pcid", DbType.Int32, ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcid).Value))
      ...
      Case PDSADataModificationState.Insert
        ...
        Select Case InsertFilter
          Case InsertFilters.All
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@posdate", DbType.Date, ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.posdate).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@pcamnt", DbType.Decimal, ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcamnt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@pcrem", DbType.String, ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.pcrem).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@cashier", DbType.String, ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.cashier).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sInsertid", DbType.String, ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.sInsertid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtInsertdt", DbType.DateTime, ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.dtInsertdt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sLastUpdateid", DbType.String, ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.sLastUpdateid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtLastUpdatedt", DbType.DateTime, ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.dtLastUpdatedt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@iConcurrencyid", DbType.Int16, ValidatorObject.Properties.GetByName(petty_cashValidator.ColumnNames.iConcurrencyid).Value))
