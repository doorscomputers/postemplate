...
''' </summary>
Partial Public Class spStocksManager
...
#Region "Private Variables"
  ...
  Private _DataObject As spStocksData
#End Region
...
#Region "Public Properties"
  ...
  ''' </summary>
  Public Property DataObject() As spStocksData
    Get
      Return _DataObject
    End Get
    Set(ByVal value As spStocksData)
      _DataObject = value
    End Set
  End Property
#End Region
...
#Region "Init Method"
  ...
  Protected Overrides Sub Init()
    ...
    If DataObject Is Nothing Then
      DataObject = New spStocksData(DataProvider, Entity)
    End If

    ClassName = "spStocksManager"
  End Sub
#End Region
End Class
