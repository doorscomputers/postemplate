...
#Region "Constructors"
  ...
  Public Sub New()
    ...
    _Entity = New location()
    ValidatorObject = New locationValidator(_Entity)
  ...
  ''' <param name="entity">An instance of a location</param>
  Public Sub New(ByVal dataProvider As PDSADataProvider, ByVal entity As location)
  ...
  Public Sub New(ByVal dataProvider As PDSADataProvider, _
    ByVal entity As location, ByVal validator As locationValidator)
...
#Region "InitDataColumns Method"
  ...
  Protected Overrides Sub InitDataColumns()
    ...
    prop = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.locid)
    ...
    prop = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.location)
    ...
    prop = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.sInsertid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlChars.Null
    ...
    prop = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.dtInsertdt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.sLastUpdateid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlChars.Null
    ...
    prop = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.dtLastUpdatedt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlDateTime.Null
    ...
    prop = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.iConcurrencyid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
...
#Region "EntityDataToColumnCollection Method"
  ...
  Protected Overrides Sub EntityDataToColumnCollection()
    ...
    ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.locid).Value = Entity.locid
    ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.location).Value = Entity.location
    ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.sInsertid).Value = Entity.sInsertid
    ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.dtInsertdt).Value = Entity.dtInsertdt
    ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.sLastUpdateid).Value = Entity.sLastUpdateid
    ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.dtLastUpdatedt).Value = Entity.dtLastUpdatedt
    ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.iConcurrencyid).Value = Entity.iConcurrencyid
  End Sub
#End Region
...
#Region "ColumnCollectionToEntityData Method"
  ...
  Protected Overrides Sub ColumnCollectionToEntityData()
    If ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.locid).IsNull = False Then
      Entity.locid = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.locid).GetAsInteger()
    Else
      Entity.locid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.location).IsNull = False Then
      Entity.location = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.location).GetAsString()
    Else
      Entity.location = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.sInsertid).IsNull = False Then
      Entity.sInsertid = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.sInsertid).GetAsString()
    Else
      Entity.sInsertid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.dtInsertdt).IsNull = False Then
      Entity.dtInsertdt = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.dtInsertdt).GetAsDate()
    Else
      Entity.dtInsertdt = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.sLastUpdateid).IsNull = False Then
      Entity.sLastUpdateid = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.sLastUpdateid).GetAsString()
    Else
      Entity.sLastUpdateid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.dtLastUpdatedt).IsNull = False Then
      Entity.dtLastUpdatedt = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.dtLastUpdatedt).GetAsDate()
    Else
      Entity.dtLastUpdatedt = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.iConcurrencyid).IsNull = False Then
      Entity.iConcurrencyid = ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.iConcurrencyid).GetAsShort()
    Else
...
#Region "CreateEntityFromDataRow Method"
  ...
  Public Function CreateEntityFromDataRow(ByVal dr As DataRow) As location
    ...
    Select Case SelectFilter
      Case SelectFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT locid, location, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id FROM dbo.location")
      ...
      Case SelectFilters.ListBox
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT locid, location FROM dbo.location")
      ...
      Case SelectFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT locid, location, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id FROM dbo.location WHERE locid = @locid")
    ...
    Select Case InsertFilter
      Case InsertFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" INSERT INTO dbo.location ( location, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id ) VALUES ( @location, @sInsertid, @dtInsertdt, @sLastUpdateid, @dtLastUpdatedt, @iConcurrencyid )")
    ...
    Select Case UpdateFilter
      Case UpdateFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" UPDATE dbo.location SET location = @location, sInsert_id = @sInsertid, dtInsert_dt = @dtInsertdt, sLastUpdate_id = @sLastUpdateid, dtLastUpdate_dt = @dtLastUpdatedt, iConcurrency_id = @iConcurrencyid WHERE locid = @locid")
...
#Region "DeleteByPK Method"
  ...
  ''' <returns>int</returns>
  Public Function DeleteByPK(ByVal locid As Integer) As Integer
    ...
    Select Case DeleteFilter
      Case DeleteFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.location")
      ...
      Case DeleteFilters.DeleteByPK
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.location WHERE locid = @locid")
    ...
    Select Case RowCountFilter
      Case RowCountFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT Count(*) As NumRecs FROM dbo.location")
...
#Region "LoadByPK Method"
  ...
  Public Function LoadByPK(ByVal locid As Integer) As Integer
  ...
  Protected Overrides Sub WhereClauseFillInParameters()
    Select Case WhereFilter
      ...
      Case WhereFilters.location
        CommandObject.Parameters.Add(DataProvider.CreateParameter("location", DbType.String, Entity.location))
      Case WhereFilters.PrimaryKey
        CommandObject.Parameters.Add(DataProvider.CreateParameter("locid", DbType.Int32, Entity.locid))
...
#Region "PrimaryKeySet Method"
  ...
  Public Overrides Sub PrimaryKeySet(ByVal locid As Integer)
    ' Fill in Entity Values
    Entity.locid = locid
    ' Fill in Columns Collection
    ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.locid).Value = locid
  End Sub
#End Region
    ...
    Select Case DataModificationAction
      Case PDSADataModificationState.Delete
        Select Case DeleteFilter
          ...
          Case DeleteFilters.DeleteByPK
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@locid", DbType.Int32, ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.locid).Value))
      ...
      Case PDSADataModificationState.Insert
        ...
        Select Case InsertFilter
          Case InsertFilters.All
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@location", DbType.String, ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.location).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sInsertid", DbType.String, ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.sInsertid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtInsertdt", DbType.Date, ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.dtInsertdt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sLastUpdateid", DbType.String, ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.sLastUpdateid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtLastUpdatedt", DbType.Date, ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.dtLastUpdatedt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@iConcurrencyid", DbType.Int16, ValidatorObject.Properties.GetByName(locationValidator.ColumnNames.iConcurrencyid).Value))
