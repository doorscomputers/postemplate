...
#Region "Constructors"
  ...
  Public Sub New()
    ...
    _Entity = New categories()
    ValidatorObject = New categoriesValidator(_Entity)
  ...
  ''' <param name="entity">An instance of a categories</param>
  Public Sub New(ByVal dataProvider As PDSADataProvider, ByVal entity As categories)
  ...
  Public Sub New(ByVal dataProvider As PDSADataProvider, _
    ByVal entity As categories, ByVal validator As categoriesValidator)
...
#Region "InitDataColumns Method"
  ...
  Protected Overrides Sub InitDataColumns()
    ...
    prop = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.categoryid)
    ...
    prop = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.catgory)
    ...
    prop = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.sInsertid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlChars.Null
    ...
    prop = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.dtInsertdt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    ...
    prop = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.sLastUpdateid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlChars.Null
    ...
    prop = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.dtLastUpdatedt)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
    prop.DBValueForNull = System.Data.SqlTypes.SqlDateTime.Null
    ...
    prop = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.iConcurrencyid)
    prop.IsInsertable = True
    prop.IsUpdatable = True
    prop.IncludeInAuditTracking = True
...
#Region "EntityDataToColumnCollection Method"
  ...
  Protected Overrides Sub EntityDataToColumnCollection()
    ...
    ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.categoryid).Value = Entity.categoryid
    ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.catgory).Value = Entity.catgory
    ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.sInsertid).Value = Entity.sInsertid
    ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.dtInsertdt).Value = Entity.dtInsertdt
    ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.sLastUpdateid).Value = Entity.sLastUpdateid
    ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.dtLastUpdatedt).Value = Entity.dtLastUpdatedt
    ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.iConcurrencyid).Value = Entity.iConcurrencyid
  End Sub
#End Region
...
#Region "ColumnCollectionToEntityData Method"
  ...
  Protected Overrides Sub ColumnCollectionToEntityData()
    If ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.categoryid).IsNull = False Then
      Entity.categoryid = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.categoryid).GetAsInteger()
    Else
      Entity.categoryid = 0
    End If
    
    If ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.catgory).IsNull = False Then
      Entity.catgory = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.catgory).GetAsString()
    Else
      Entity.catgory = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.sInsertid).IsNull = False Then
      Entity.sInsertid = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.sInsertid).GetAsString()
    Else
      Entity.sInsertid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.dtInsertdt).IsNull = False Then
      Entity.dtInsertdt = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.dtInsertdt).GetAsDate()
    Else
      Entity.dtInsertdt = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.sLastUpdateid).IsNull = False Then
      Entity.sLastUpdateid = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.sLastUpdateid).GetAsString()
    Else
      Entity.sLastUpdateid = String.Empty
    End If
    
    If ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.dtLastUpdatedt).IsNull = False Then
      Entity.dtLastUpdatedt = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.dtLastUpdatedt).GetAsDate()
    Else
      Entity.dtLastUpdatedt = Convert.ToDateTime("1/1/1753", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat)
    End If
    
    If ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.iConcurrencyid).IsNull = False Then
      Entity.iConcurrencyid = ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.iConcurrencyid).GetAsShort()
    Else
...
#Region "CreateEntityFromDataRow Method"
  ...
  Public Function CreateEntityFromDataRow(ByVal dr As DataRow) As categories
    ...
    Select Case SelectFilter
      Case SelectFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT categoryid, catgory, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id FROM dbo.categories")
      ...
      Case SelectFilters.ListBox
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT categoryid, catgory FROM dbo.categories")
      ...
      Case SelectFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT categoryid, catgory, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id FROM dbo.categories WHERE categoryid = @categoryid")
    ...
    Select Case InsertFilter
      Case InsertFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" INSERT INTO dbo.categories ( catgory, sInsert_id, dtInsert_dt, sLastUpdate_id, dtLastUpdate_dt, iConcurrency_id ) VALUES ( @catgory, @sInsertid, @dtInsertdt, @sLastUpdateid, @dtLastUpdatedt, @iConcurrencyid )")
    ...
    Select Case UpdateFilter
      Case UpdateFilters.PrimaryKey
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" UPDATE dbo.categories SET catgory = @catgory, sInsert_id = @sInsertid, dtInsert_dt = @dtInsertdt, sLastUpdate_id = @sLastUpdateid, dtLastUpdate_dt = @dtLastUpdatedt, iConcurrency_id = @iConcurrencyid WHERE categoryid = @categoryid")
...
#Region "DeleteByPK Method"
  ...
  ''' <returns>int</returns>
  Public Function DeleteByPK(ByVal categoryid As Integer) As Integer
    ...
    Select Case DeleteFilter
      ...
      Case DeleteFilters.DeleteByPK
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" DELETE FROM dbo.categories WHERE categoryid = @categoryid")
    ...
    Select Case RowCountFilter
      Case RowCountFilters.All
        If UseStoredProcs Then
          sb.Append("")
        Else
            sb.Append(" SELECT Count(*) As NumRecs FROM dbo.categories")
...
#Region "LoadByPK Method"
  ...
  Public Function LoadByPK(ByVal categoryid As Integer) As Integer
...
#Region "WhereClauseSQL Method"
  ...
  Public Overrides Function WhereClauseSQL() As String
    ...
    Select Case WhereFilter
      ...
      Case WhereFilters.catgory
        sb.Append(" WHERE catgory = @catgory")
          
      Case WhereFilters.Likecatgory
        sb.Append(" WHERE catgory LIKE @catgory")
...
#Region "WhereClauseFillInParameters Method"
  ...
  Protected Overrides Sub WhereClauseFillInParameters()
    Select Case WhereFilter
      Case WhereFilters.catgory
        CommandObject.Parameters.Add(DataProvider.CreateParameter("catgory", DbType.String, Entity.catgory))
      Case WhereFilters.Likecatgory
        CommandObject.Parameters.Add(DataProvider.CreateParameter("catgory", DbType.String, Entity.catgory))
      Case WhereFilters.PrimaryKey
...
#Region "OrderByClauseSQL Method"
  ...
  Public Overrides Function OrderByClauseSQL() As String
    ...
    Select Case OrderByFilter
      ...
      Case OrderByFilters.catgory
          sb.Append(" ORDER BY catgory")
...
#Region "PrimaryKeySet Method"
  ...
  Public Overrides Sub PrimaryKeySet(ByVal categoryid As Integer)
    ' Fill in Entity Values
    Entity.categoryid = categoryid
    ' Fill in Columns Collection
    ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.categoryid).Value = categoryid
  End Sub
#End Region
    ...
    Select Case DataModificationAction
      Case PDSADataModificationState.Delete
        Select Case DeleteFilter
          ...
          Case DeleteFilters.DeleteByPK
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@categoryid", DbType.Int32, ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.categoryid).Value))
      ...
      Case PDSADataModificationState.Insert
        ...
        Select Case InsertFilter
          Case InsertFilters.All
            CommandObject.Parameters.Clear()
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@catgory", DbType.String, ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.catgory).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sInsertid", DbType.String, ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.sInsertid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtInsertdt", DbType.Date, ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.dtInsertdt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@sLastUpdateid", DbType.String, ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.sLastUpdateid).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@dtLastUpdatedt", DbType.Date, ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.dtLastUpdatedt).Value))
            CommandObject.Parameters.Add(DataProvider.CreateParameter("@iConcurrencyid", DbType.Int16, ValidatorObject.Properties.GetByName(categoriesValidator.ColumnNames.iConcurrencyid).Value))
